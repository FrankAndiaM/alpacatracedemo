...
const FilterDate: React.FC<FilterDateProps> = (props: FilterDateProps) => {
  ...
  return (
    <Box mt={1}>
      ...
      >
        ...
        <FormControlLabel value="day_last" control={<Radio />} label="Creado en las últimas 24 horas" />
        <FormControlLabel value="week_last" control={<Radio />} label="Creados la semana pasada" />
        <FormControlLabel value="month_last" control={<Radio />} label="Creados el mes pasado" />
      </RadioGroup>
      <Box>
