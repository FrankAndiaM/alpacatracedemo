...
type IssueCredentialToProducerDialogProps = {
  credentialId: string;
...
const IssueCredentialToProducerDialog: React.FC<IssueCredentialToProducerDialogProps> = (
  props: IssueCredentialToProducerDialogProps
) => {
  const { credentialId, onClose }: IssueCredentialToProducerDialogProps = props;
...
export default IssueCredentialToProducerDialog;
