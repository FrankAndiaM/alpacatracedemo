...
import { downloadErrorRecords, paginateIndividualRegisterTransaction } from '~services/massive_load_clothes';
...
type ShowMassiveLoadProfileProps = any;
...
const ShowMassiveLoadProfile: React.FC<ShowMassiveLoadProfileProps> = () => {
  const {
    auth: {
  ...
  const _paginateIndividualRegisterTransaction = useCallback(
    (page: number, per_page: number, sort_by: string, order: string, search: string) => {
      return paginateIndividualRegisterTransaction(
        file_loaded_id ?? '',
        page,
        per_page,
        sort_by,
            ...
            <Box>
              <Breadcrumbs
                breadcrumbs={[
                  ...
                  // },
                  {
                    path: routes.clothesFileListLoaded,
...
export default ShowMassiveLoadProfile;
