 ...
 */
function paginateMassiveLoadPanelsTransaction(
  type: string,
  page: number,
  perPage: number,
  sortBy: string,
  ...
  let url = `/massive_load_clothes/fabric_inventories?record_status=${type}&page=${page}&per_page=${perPage}&sort_by=${sortBy}`;
 ...
 */
function paginateIndividualRegisterPanelsTransaction(
  ...
  let url = `massive_load_clothes/fabric_inventories/${massiveLoadProfileProducerId}/records?page=${page}&per_page=${perPage}`;
...
export {
  paginateMassiveLoadPanelsTransaction,
  uploadMassiveLoadTransaction,
  paginateIndividualRegisterPanelsTransaction,
