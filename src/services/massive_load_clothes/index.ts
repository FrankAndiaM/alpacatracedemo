...
function paginateMassiveLoadTransaction(
  ...
  let url = `/massive_load_clothes/clothes?record_status=${type}&page=${page}&per_page=${perPage}&sort_by=${sortBy}`;
...
function paginateIndividualRegisterTransaction(
  ...
  let url = `massive_load_clothes/clothes/${massiveLoadProfileProducerId}/records?page=${page}&per_page=${perPage}`;
